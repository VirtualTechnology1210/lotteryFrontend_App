...
const DigitSummaryScreen = ({ navigation }) => {
    ...
    const handleSubmit = () => {
        ...
        navigation.navigate('DigitSummaryResult', { filters: params });
    };
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.filterContainer}>
                    <View style={styles.sectionHeader}>
                        <MaterialCommunityIcons name="filter-variant" size={22} color="#3a48c2" />
                    ...
                    <View style={styles.actionButtons}>
                        ...
                        >
                            <>
                                <MaterialCommunityIcons name="numeric" size={20} color="#fff" />
...
export default DigitSummaryScreen;
